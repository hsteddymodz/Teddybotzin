...
const enviar = (texto) => {
bkz.sendMessage(from, {text: texto }, {quoted: info })}
...
│• Nome Bot: ${nomebot}
╰ • Criador: ${nomedono}`
await bkz.sendMessage(from, {text: menu, mentions: [sender]}, {quoted: info });
break
...
│• Nome Bot: ${nomebot}
╰ • Criador: ${nomedono}`
await bkz.sendMessage(from, {image: {url: 'https://telegra.ph/file/414bd9e7830c4d828b535.jpg' }, caption: menu2, mentions: [sender]}, {quoted: info });
break
...
│• Nome Bot: ${nomebot}
╰ • Criador: ${nomedono}`
await bkz.sendMessage(from, {image: fs.readFileSync('./arquivos/logo.jpg'), caption: menu3, mentions: [sender]}, {quoted: info });
break

case 'texto':
await bkz.sendMessage(from, {text: 'Seu texto aqui.' }, {quoted: info });
break

case 'audio':
await bkz.sendMessage(from, {audio: fs.readFileSync('./arquivos/áudio.mp3')}, {quoted: info });
break

case 'audiowave':
await bkz.sendMessage(from, {audio: fs.readFileSync('./arquivos/áudio.mp3'), waveform: 'AAY8KTlLNx4/LTsjHytkLzBDIBExGC8aHRAPRzE+T0YkTyEpGyIWRCkXLyMQCyw0YB04P0EwGCs3HxEiECopGw==', mimetype: "audio/mp4", ptt: true }, {quoted: info });
break

case 'audioptt':
await bkz.sendMessage(from, {audio: fs.readFileSync('./arquivos/áudio.mp3'), mimetype: 'audio/mp4', ptt: true }, {quoted: info });
break

case 'imagem':
await bkz.sendMessage(from, {image: fs.readFileSync('./arquivos/logo.jpg')}, {quoted: info });
break

case 'imagemlegenda':
await bkz.sendMessage(from, {image: fs.readFileSync('./arquivos/logo.jpg'), caption: 'Legenda'}, {quoted: info });
break

case 'video':
await bkz.sendMessage(from, {video: fs.readFileSync('./arquivos/video.mp4')}, {quoted: info });
break

case 'videolegenda':
await bkz.sendMessage(from, {video: fs.readFileSync('./arquivos/video.mp4'), caption: 'Legenda'}, {quoted: info });
break

case 'figurinha':
await bkz.sendMessage(from, {sticker: fs.readFileSync('./arquivos/figurinha.webp')}, {quoted: info });
break

case 'documentozip':
await bkz.sendMessage(from, {document: fs.readFileSync('./arquivos/documento.zip'), fileName: 'Bkz-Base.zip', mimetype: 'application/zip'}, {quoted: info });
break

case 'localização':
await bkz.sendMessage(from, {location: fs.readFileSync('./arquivos/localização.loc'), caption: 'Localização'}, {quoted: info });
break
...
bkz.relayMessage(from, extended.message, {messageId: extended.key.id})
} catch (e) {
console.log(e)
}
...
if (response === '{}') return
return bkz.sendMessage(from, {text: response }).catch(e => {
enviar(String(e))})
} catch (e) {
enviar(String(e))}}

if (budy === prefixo) {
await bkz.sendMessage(from, {text: `Se desejar visualizar o menu, por favor, digite ${prefixo}menu` }, {quoted: info} );
} else if (budy.startsWith(prefixo)) {
await bkz.sendMessage(from, {text: `Desculpe, esse comando não existe.` }, {quoted: info });
}
}
}
}
